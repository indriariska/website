 ...
 * All requests go to http://localhost:3000/api/customer
 */
const CUSTOMER_API = 'http://localhost:3000/api/customer';
...
class CustomerAPI {
  ...
  static async uploadRevisionFile(id, file) {
    ...
    const res = await fetch(`http://localhost:3000/api/customer/orders/${id}/revision-file`, {
      method: 'POST',
